            ...
            <div class="col-md-15">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Knowledgebase&nbsp;&nbsp;<small class="label pull-right bg-yellow"></small></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table class="table table-bordered">
					...
					<td></td>
					<a class="btn btn-app" href="addclient.php">
                    <i class="fa fa-question"></i> New Question
					</a>
                  </table>
				<div class="container">
				</div>
