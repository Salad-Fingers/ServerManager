            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Edit rCON Password</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form action="editrcon_c.php" method="post">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="svRCON">New rCON Password</label>
                      <input type="text" class="form-control" name="svRCON"/>
                    </div>
                  </div><!-- /.box-body -->
