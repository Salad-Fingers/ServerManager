                ...
                <form action="category_add.php" method="post">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="CatName" placeholder="Ex:. General" />
                    </div>
                  <div class="form-group">
                      <label for="CatDesc">Description</label>
                      <input type="text" class="form-control" name="CatDesc" placeholder="Ex:. Its about anything" />
                    </div>
                  </div><!-- /.box-body -->
