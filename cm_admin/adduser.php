          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form action="adduser_c.php" method="post">
                  <div class="box-body">
				  <label for="Username">Username</label>
                    <div class="input-group">
                      <span class="input-group-addon"><i class="fa fa-user"></i></span>
                      <input type="text" class="form-control" name="Username" placeholder="New user's name" />
                    </div><br />
				 <label for="EMail">E-Mail</label>
				  ...
				  <div class="input-group">
					...
					<div class="input-group">
                      ...
                      <input type="text" class="form-control" name="Fullname" placeholder="Carl CJ Johnson" />
                    </div><br />
					<label for="Rights">Rights</label>
					<div class="input-group">
					<span class="input-group-addon"><i class="fa fa-wrench"></i></span> 					
					  <input type="text" class="form-control" name="Rights" placeholder="1-10" />
					 </div><br />
					 ...
					 <span class="input-group-addon"><img src="http://unrealsoftware.de/img/pub/unrealsoftware_icon.gif"></img></span> 
					  <input type="text" class="form-control" name="USGN" placeholder="6943" />
					 </div>
                  </div><!-- /.box-body -->
