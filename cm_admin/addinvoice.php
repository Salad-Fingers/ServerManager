          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form action="addinv_c.php" method="post">
                  <div class="box-body">
				  <label for="invClient">Client</label>
                    <div class="input-group">
                     <span class="input-group-addon"><i class="fa fa-user"></i></span> 
                    <input type="text" class="form-control" name="invClient"/>
                    </div><br />
				    <label for="invAmount">Amount</label>
                    <div class="input-group">
                     <span class="input-group-addon"><i class="fa fa-usd"></i></span> 
                    <input type="text" class="form-control" name="invAmount"/>
                    </div><br />
					<label for="invCreated">Created</label>
					<div class="input-group">
                      <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                      <input type="text" class="form-control" name="invCreated" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask>
                    </div><br />
					<label for="invDue">Due Date</label>
					<div class="input-group">
                      <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                      <input type="text" class="form-control" name="invDue" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask>
                    </div><br />
						<div class="form-group">
                      <label for="invStatus">Status</label>
                      <select class="form-control" name="invStatus">
						<option><span class='badge bg-red'>Unpaid</span></option>
						<option><span class='badge bg-green'>Paid</span></option>
                      </select>
                    </div>
                  </div><!-- /.box-body -->
