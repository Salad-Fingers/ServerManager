            ...
            <div class="col-md-15">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Packages&nbsp;&nbsp;<small class="label pull-right bg-yellow"></small></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table class="table table-bordered">
					...
					<td><?php getPackages();?></td>
					<a class="btn btn-app" href="addpackage.php">
                    <i class="fa fa-dropbox"></i> New Package
					</a>
                  </table>
				<div class="container">
				</div>
