            ...
            <div class="col-md-15">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Servers&nbsp;&nbsp;<small class="label pull-right bg-yellow"><?php getServersNum();?></small></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
				<?
				...
				?>
                  <table class="table table-bordered">
					...
					<td><?php getServers(); ?></td>
					<a class="btn btn-app" href="addserver.php">
                    <i class="fa fa-terminal"></i> Add Server
					</a>
                  </table>
				<div class="container">
				</div>
