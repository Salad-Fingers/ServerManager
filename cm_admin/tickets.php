            ...
            <div class="col-md-15">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Tickets&nbsp;&nbsp;<small class="label pull-right bg-yellow"></small></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table class="table table-bordered">
					...
					<td><?php getTickets();?></td>
					<a class="btn btn-app" href="newticket.php">
                    <i class="fa fa-send-o"></i> New Ticket
					</a>
                  </table>
				<div class="container">
				</div>
