          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form action="addpackage_c.php" method="post">
                  <div class="box-body">
				  <label for="pkgName">Name</label>
                    <div class="input-group">
                     <span class="input-group-addon"><i class="fa fa-dropbox"></i></span> 
                    <input type="text" class="form-control" name="pkgName"/>
                    </div><br />
				    <div class="form-group">
                      <label for="pkgType">Type</label>
					...
					<div class="form-group">
                      <label for="pkgPayType">Pay Type</label>
                      <select class="form-control" name="pkgPayType">
					...
					<div class="form-group">
                      <label for="pkgSetup">Setup</label>
                      <select class="form-control" name="pkgSetup">
					...
					<div class="input-group">
                      ...
                      <input type="text" class="form-control" name="pkgPrice" placeholder="0.00">
                    </div><br />
