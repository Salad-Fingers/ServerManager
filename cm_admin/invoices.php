            ...
            <div class="col-md-15">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Invoices&nbsp;&nbsp;<small class="label pull-right bg-yellow"></small></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table class="table table-bordered">
					...
					<td><?php getInvoices(); ?></td>
					<a class="btn btn-app" href="addinvoice.php">
                    <i class="fa fa-list-alt"></i> New Invoice
					</a>
                  </table>
				<div class="container">
				</div>
